...
void Lcd_cmd_data(unsigned char datos,unsigned char cmd_data,unsigned char bits)
{
    ...
    if (bits == 1)
    {
        ...
        PORTDbits.RD4 = (nhigh >> 0) & 0x01;
        PORTDbits.RD5 = (nhigh >> 1) & 0x01;
        PORTDbits.RD6 = (nhigh >> 2) & 0x01;
        PORTDbits.RD7 = (nhigh >> 3) & 0x01;
        }
    PORTEbits.RE0 = cmd_data;
    ...
    {
        PORTDbits.RD4 = PORTDbits.RD5 = PORTDbits.RD6 = PORTDbits.RD7 = 0;
        PORTDbits.RD4 = (nlow >> 0) & 0x01;
        PORTDbits.RD5 = (nlow >> 1) & 0x01;
        PORTDbits.RD6 = (nlow >> 2) & 0x01;
        PORTDbits.RD7 = (nlow >> 3) & 0x01;
        PORTEbits.RE0 = cmd_data;
        _delay((unsigned long)((100)*(4000000/4000000.0)));
        PORTEbits.RE2 = 1;
        _delay((unsigned long)((1)*(4000000/4000.0)));
...
void Lcd_inicio_4bits(void)
{
    ...
    Lcd_cmd_data(0x03,0x00,0x01);_delay((unsigned long)((5)*(4000000/4000.0)));
    Lcd_cmd_data(0x03,0x00,0x01);_delay((unsigned long)((150)*(4000000/4000000.0)));
    Lcd_cmd_data(0x03,0x00,0x01);_delay((unsigned long)((150)*(4000000/4000000.0)));
    Lcd_cmd_data(0x02,0x00,0x01);_delay((unsigned long)((150)*(4000000/4000000.0)));
    Lcd_cmd_data(0x28,0x00,0x01);
    Lcd_cmd_data(0x0C,0x00,0x01);
    Lcd_cmd_data(0x06,0x00,0x01);
    Lcd_cmd_data(1,0x00,0x01);
