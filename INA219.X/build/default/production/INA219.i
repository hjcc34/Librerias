...
# 1 "./CFG_INA219.h" 1
# 11 "./CFG_INA219.h"
# 1 "./../../FVV_V1.0/FV.X/CFG_16F877A.h" 1
# 11 "./../../FVV_V1.0/FV.X/CFG_16F877A.h"
...
# 23 "./../../FVV_V1.0/FV.X/CFG_16F877A.h" 2
...
# 24 "./../../FVV_V1.0/FV.X/CFG_16F877A.h" 2
# 1 "./../../FVV_V1.0/FV.X/CFG_RS-232.h" 1
# 11 "./../../FVV_V1.0/FV.X/CFG_RS-232.h"
# 1 "./../../FVV_V1.0/FV.X/CFG_16F877A.h" 1
# 12 "./../../FVV_V1.0/FV.X/CFG_RS-232.h" 2
...
# 25 "./../../FVV_V1.0/FV.X/CFG_16F877A.h" 2
# 1 "./../../FVV_V1.0/FV.X/CFG_LCD.h" 1
# 11 "./../../FVV_V1.0/FV.X/CFG_LCD.h"
# 1 "./../../FVV_V1.0/FV.X/CFG_16F877A.h" 1
# 12 "./../../FVV_V1.0/FV.X/CFG_LCD.h" 2
# 54 "./../../FVV_V1.0/FV.X/CFG_LCD.h"
char aux[20]=" ";
unsigned char contador2;


int const caracter0_direccion[9]={0x40,0x41,0x42,0x43,0x44,0x45,0x46,0x47,0x80};
int const caracter0_datos[9]={0b00001,0b00011,0b00101,0b11001,0b11001,0b00101,0b00011,0b0,0x00};

int const caracter1_direccion[9]={0x48,0x49,0x4a,0x4b,0x4c,0x4d,0x4e,0x4f,0x81};
int const caracter1_datos[9]={0b00001,0b00101,0b10101,0b10101,0b10101,0b00101,0b00001,0b0,0x01};

int const caracter2_direccion[9]={0x50,0x51,0x52,0x53,0x54,0x55,0x56,0x57,0x81};
int const caracter2_datos[9]={0b00000,0b10001,0b01010,0b00100,0b01010,0b10001,0b00000,0b0,0x02};
...
# 26 "./../../FVV_V1.0/FV.X/CFG_16F877A.h" 2
# 1 "./../../FVV_V1.0/FV.X/CFG_I2C.h" 1
# 11 "./../../FVV_V1.0/FV.X/CFG_I2C.h"
# 1 "./../../FVV_V1.0/FV.X/CFG_16F877A.h" 1
# 12 "./../../FVV_V1.0/FV.X/CFG_I2C.h" 2
...
# 27 "./../../FVV_V1.0/FV.X/CFG_16F877A.h" 2
# 1 "./../../FVV_V1.0/FV.X/CFG_INA219.h" 1
# 28 "./../../FVV_V1.0/FV.X/CFG_16F877A.h" 2
# 1 "./../../FVV_V1.0/FV.X/CFG_CONV_DEC_LCD.h" 1
# 11 "./../../FVV_V1.0/FV.X/CFG_CONV_DEC_LCD.h"
# 1 "./../../FVV_V1.0/FV.X/CFG_16F877A.h" 1
# 12 "./../../FVV_V1.0/FV.X/CFG_CONV_DEC_LCD.h" 2

long variableU,variableC,variableD,variableM,variableUM,variableDM,ResultadoINA,signo,ResultadoINA_P;
int ResultadoINA_A,ResultadoINA_A_NEG,dosmillar,unmillar,millar,centena,decena,unidad;

void CONVERSOR_HEX_DEC(long variable);
int Resultado_INA219(void);
int Resultado_INA219_A_P(void);
# 29 "./../../FVV_V1.0/FV.X/CFG_16F877A.h" 2
# 1 "./../../FVV_V1.0/FV.X/CFG_PWM.h" 1
# 11 "./../../FVV_V1.0/FV.X/CFG_PWM.h"
# 1 "./../../FVV_V1.0/FV.X/CFG_16F877A.h" 1
# 12 "./../../FVV_V1.0/FV.X/CFG_PWM.h" 2
...
void PWM_IN_AN1();
void PWM_IN_AN3();
# 30 "./../../FVV_V1.0/FV.X/CFG_16F877A.h" 2
# 1 "./../../FVV_V1.0/FV.X/CFG_ADC.h" 1
# 11 "./../../FVV_V1.0/FV.X/CFG_ADC.h"
# 1 "./../../FVV_V1.0/FV.X/CFG_16F877A.h" 1
# 12 "./../../FVV_V1.0/FV.X/CFG_ADC.h" 2
...
# 31 "./../../FVV_V1.0/FV.X/CFG_16F877A.h" 2
# 12 "./CFG_INA219.h" 2
...
void CFG_INA219_32V_3A(void)
{
    ...
    I2C_P();
    Lcd_print_string(5,"INA219",3,"Configurado");
